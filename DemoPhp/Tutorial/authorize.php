...
<html>
<head>
	<title>Authorize account (Allow access to your cTrader account)</title>
	<style type="text/css">
		body{background: url(https://www.spotware.com/bg.png);}
		.btn1, .btn2{float: left; width: auto; padding: 10px; background: #202033; color: #fff; margin: 1%; border-radius: 0px; text-decoration: none; font-family: Tahoma; width: 98%; box-sizing: border-box; border-radius: 0px 0px 0px 0px }
...
<!-- it redirect user to playground, user need login and then he can connect accounts to our applicaton -->
